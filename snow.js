function renderSnowContainer() {
  ...
  const flakeImages = [
    'img/flakes/flake.png',
    'img/flakes/flake2.png',
    'img/flakes/flake3.png',
  ];
  ...
  function renderSanta(snowContainer) {
    ...
    sleighImg.src = 'img/santa/sleigh.png';
    ...
    for (let i = 0; i < 3; i++) {
      ...
      reindeerImg.src = 'img/santa/reindeer.png';
  ...
  function addAudioElement(snowContainer) {
    ...
    audioElement.src = 'sounds/sounds_jinglebells.mp3';
    audioElement.play();
